...
/**
  Класс Gas - представляет из себя отдельный компонент газовой смеси.
  Данный класс предназначен для хранения коэффициентов используемых при расчете
  коэффициента динамической вязкости по ГОСТ Р 8.770—2011 (Уравнение AGA8).
*/
